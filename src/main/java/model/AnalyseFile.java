...
public class AnalyseFile
{
     ...
     */
    public static Hashtable<String, Integer> sortHT(Hashtable<String, Integer> ht)
    {
        // TODO: A finir cette func
        return null;
    }
    ...
    public static void test()
    {
        ...
        Hashtable<String, Integer> ht = AnalyseFile.getHTofText(text, 3);
        DisplayHT.print(ht, "Bee Movie Script",3);
    }
}
